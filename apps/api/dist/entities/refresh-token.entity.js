...
], RefreshToken.prototype, "schoolId", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'token_hash', type: 'varchar', length: 64, unique: true }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.Column)({ name: 'replaced_by', type: 'varchar', length: 64, nullable: true }),
    __metadata("design:type", Object)
